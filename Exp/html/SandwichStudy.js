...
function Study_Info_SheetRoutineBegin() {
  ...
  for (const thisComponent of Study_Info_SheetComponents)
...
function Full_Info_SheetRoutineBegin() {
  ...
  for (const thisComponent of Full_Info_SheetComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function VegQuestionLoopLoopBegin(thisScheduler) {
  ...
  for (const thisVegQuestionLoop of VegQuestionLoop) {
...
function BreakConditionalLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisBreakConditional of BreakConditional) {
...
function VegQuestionRoutineBegin() {
  ...
  for (const thisComponent of VegQuestionComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function VegConfirmRoutineBegin() {
  ...
  for (const thisComponent of VegConfirmComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function PresentSandMainRoutineBegin() {
  ...
  for (const thisComponent of PresentSandMainComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function MidwayBreakRoutineBegin() {
  ...
  for (const thisComponent of MidwayBreakComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Initialize_ratingRoutineBegin() {
  ...
  for (const thisComponent of Initialize_ratingComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function IngredientRatingRoutineBegin() {
  ...
  for (const thisComponent of IngredientRatingComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
